...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      <div className="flex flex-col gap-72 w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative  ">
        ...
        <img
          src={CARD_2}
          alt="Cards"
          className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15 rounded-[25px]"
        />
      </div>
    </div>
  );
